...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Генератор мемов: загрузите фото, добавьте текст и скачайте готовый мем.",
      },
      ...
      <body className="bg-bg text-fg">
        ...
        <Toaster
          ...
          toastOptions={{
            classNames: {
              toast:
                "bg-elevated text-fg border border-border shadow-none font-sans",
              title: "text-fg",
